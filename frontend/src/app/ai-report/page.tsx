    ...
    <AppLayout>
      <div className="flex flex-col gap-6 max-w-2xl">
              ...
              <div className="flex items-center gap-2 mb-4 pb-3 border-b border-[#2d3748]">
                {activeProvider === 'openai' ? (
                  <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg bg-emerald-500/15 border border-emerald-500/20">
                    ...
                    <span className="text-[11px] font-medium text-emerald-400">Generated by ChatGPT</span>
                  </div>
                ) : activeProvider === 'ollama' ? (
                  <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg bg-orange-500/15 border border-orange-500/20">
                    <Sparkles size={11} className="text-orange-400" />
                    <span className="text-[11px] font-medium text-orange-400">Generated by Mongol (local)</span>
                  </div>
                ) : (
        ...
        <div className="p-4 rounded-xl bg-surface-2 text-xs text-text-secondary flex flex-col gap-1.5">
          ...
          <p className="mt-1">
            Requires <code className="font-mono text-primary">ANTHROPIC_API_KEY</code> (Claude) or{' '}
            <code className="font-mono text-primary">OPENAI_API_KEY</code> (ChatGPT) set in the backend <code className="font-mono text-primary">.env</code> file.
          </p>
        </div>
      </div>
    </AppLayout>
